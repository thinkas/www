<html lang=cn>
	<head>
		...
		<title>Minecraft梦幻仙境 - 官方商店</title>
		<meta name="keywords" content="梦幻仙境,Minecraft梦幻仙境,梦幻仙境服务器,Minecraft梦幻仙境,梦幻仙境服务器,mc服务器,我的世界服务器,我的世界梦幻仙境,minecraft服务器"/>
		<meta name="description" content="Minecraft梦幻仙境是一个主打可玩性的服务器。"/>
		<meta name="author" content="cx工作室"/>
		...
		<div class="container-fluid">
			<nav class="navbar navbar-inverse navbar-fixed-top" id="nav">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"role="gun">Minecraft梦幻仙境</a>
				</div>
				<div class="collapse navbar-collapse" id="navlist">
					<ul class="nav navbar-nav" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" href="/articleList">游戏公告</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="/#clogin">游戏活动</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="/#qqgroup">游戏介绍</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="tese.html">游戏特色</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="/tese">联系客服</a>
						</li>
					</ul>
				</div>
			</nav>
	...
	<div class="container text-center">
		<div class="row">
			<div class="col-md-12">
			<img src="images/minecraft.png" class="img-responsive mclogo"/></div>
            <img src="images/title.png" class="img-responsive logo"/>
		</div>
		<div class="row buttons2">
			...
			<div class="col-md-2 col-xs-6">
				<a href="mod.html"role="gun" class="button button-glow button-action btn-block yh">MOD列</a>
			</div>
			...
			<div class="col-md-2 col-xs-6">
				<a href="tese.html" role="gun" class="button button-glow button-royal btn-block yh">玩法介绍</a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container box">
		<div class="row">
			<div class="col-md-3 col-xs-12" id="buttons">
				...
				<div class="row buttons">
					<div class="col-xs-12 col-md-12 XButton1">
						<a href="chat_rule.html" target="_blank" class="button button-glow button-rounded button-action btn-block yh XButton"><i class="fa fa-commenting fa-3x"></i><br>玩法介绍</a>
					</div>
				</div>
				<div class="row buttons">
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/42b223f1794e4807b3c88554d944fad9.gif">
			</div>
			<div class="item">
				<img src="images/42b223f1794e4807b3c88554d944fad9.gif" alt="Second slide">
			</div>
			<div class="item">
				<img src="images/42b223f1794e4807b3c88554d944fad9.gif" alt="Third slide">
			</div>
		</div>
...
<div class="col-xs-12 col-sm-12 webitem">
	<div class="col-sm-3">
		<img class="img-responsive" src="images/timthumb.php">
	</div>
	<div class="col-sm-9">
		<h4>
...
<div class="col-xs-12 col-sm-12 webitem">
	<div class="col-sm-3">
		<img class="img-responsive" src="images/none.png">
	</div>
	<div class="col-sm-9">
		<h4>
	...
	<div class="container box">
		<div class="row">
			...
			<div class="col-md-5 l-hr">
				<p><img class="img-responsive" src="images/clogin.png"/></p>
			...
			<div class="col-md-7">
				<p><img class="img-responsive" src="images/clogin.jpg"/></p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container text-center">
		<div class="row">
			<div class="col-md-12">
				...
				<hr color="#fff"></hr>
				<p>Minecraft梦幻仙境官方① | 群号:1047123048 <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=vjbpmJLc"><img border="0" src="images/group.png" alt="Minecraft无忧世界" title="Minecraft无忧世界"></a></p>
				<p>Minecraft梦幻仙境vip用户② | 群号:796846053 <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=L7jsqxsw"><img border="0" src="images/group.png" alt="Minecraft绚丽彩虹" title="Minecraft绚丽彩虹"></a></p>
			</div>
		</div>
	</div>
</section>
...
<section class="container-fluid" id="admin">
	<div class="container box">
		<div class="row text-center">
			...
			<div class="col-md-3">
				<div class="modbox">
					<center><img class="img-responsive" src="images/59565deab17f42fc85c9002be0768bf2.gif"/></center>
					<h3>[绚丽彩虹] xlch</h3>
					服主<br>
					QQ:408214421
				</div>
			...
			<div class="col-md-3">
				<div class="modbox">
					<center><img class="img-responsive" src="images/eb9d2d02f578467289300b737c8e5f29.gif"/></center>
					<h3>[羊夫] HHH_sheep</h3>
					策划、建筑、副本制作<br>
					QQ:194550296
				</div>
			...
			<div class="col-md-3">
				<div class="modbox">
					<center><img class="img-responsive" src="images/c994f49218984e78876631beaa2df19e.gif"/></center>
			...
			<div class="col-md-3">
				<div class="modbox">
					<center><img class="img-responsive" src="images/bc072cfe9d0d4ceaa4e464f92886c50c.gif"/></center>
					<h3>[技术顾问] Assassin</h3>
					BUG挖掘、MOD技术顾问<br>
					QQ:1541658932
				</div>
